    ...
    <el-form label-position="right" :model="query" class="form p_4" label-width="120">
      ...
      <el-row class="rows row2">
         ...
         <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
            ...
            <el-button v-if="user_group == '管理员' || $check_action('/interview_notification/table','add') || $check_action('/interview_notification/view','add')" @click="$router.push('./view?')" class="add">添加</el-button>
						
            <el-button v-if="user_group == '管理员' || $check_action('/interview_notification/table','del') || $check_action('/interview_notification/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
                        </el-col>
                ...
                <el-table-column fixed type="selection" tooltip-effect="dark" width="55">
                      ...
                      {{ get_user_regular_users(scope.row['regular_users']) }}
                               ...
                               v-if="user_group == '管理员' || $check_field('get','work_city')" min-width="200">
                                              ...
                                              <el-table-column prop="interview_time" @sort-change="$sortChange" label="面试时间"
                               v-if="user_group == '管理员' || $check_field('get','interview_time')" min-width="200">
                                      <template slot-scope="scope">
                      {{ $toTime(scope.row["interview_time"],"yyyy-MM-dd hh:mm:ss") }}
                    </template>
                                </el-table-column>
                                              <el-table-column prop="interview_notes" @sort-change="$sortChange" label="面试备注"
                               v-if="user_group == '管理员' || $check_field('get','interview_notes')" min-width="200">
                                </el-table-column>
      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                ...
                <el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/interview_notification/table','set') || $check_action('/interview_notification/view','set') || $check_action('/interview_notification/view','get') || $check_action('/${table.tableConfig.table_nav_name}/table','add') || $check_action('/${table.tableConfig.table_nav_name}/view','add')" >
        

      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
                     v-if="user_group == '管理员' || $check_action('/interview_notification/table','set') || $check_action('/interview_notification/view','set') || $check_action('/interview_notification/view','get')"
  ...
  export default {
    ...
    data() {
      return {
        ...
        showModal: false,
        // 获取数据地址
        url_get_list: "~/api/interview_notification/get_list?like=0",
        url_del: "~/api/interview_notification/del?",
