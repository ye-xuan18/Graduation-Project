				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<table_enterprise_users v-if="$check_action('/enterprise_users/table','get')"></table_enterprise_users>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_enterprise_users from "../../components/diy/table_enterprise_users.vue";
	export default {
		data() {
			return {
			};
