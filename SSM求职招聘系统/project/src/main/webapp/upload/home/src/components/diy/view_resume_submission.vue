	...
	export default {
		...
		methods: {
			...
			get_obj_after(json, func){
																																																	...
																																																	if(json.result.obj["submission_time"]=="0000-00-00 00:00:00"){
				  json.result.obj["submission_time"] = null;
				}
				if(parseInt(json.result.obj["submission_time"]) > 9999){
					json.result.obj["submission_time"] = this.$toTime(parseInt(json.result.obj["submission_time"]),"yyyy-MM-dd hh:mm:ss")
				}
