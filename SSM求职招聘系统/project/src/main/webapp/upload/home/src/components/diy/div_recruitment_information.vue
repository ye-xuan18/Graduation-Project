	...
	<div class="diy_details_box diy_div_recruitment_information">
		<div class="warp diy_warp">
			...
			<div class="details_btn_wrap">
																											<button class="btn btn-primary details_btn" v-if="$check_action('/resume_submission/edit','add')" @click="to_form('/resume_submission/edit')" ><span> 投递</span> </button>
																		<button class="btn btn-primary details_btn" v-if="$check_action('/job_consultation/edit','add')" @click="to_form('/job_consultation/edit')" ><span> 咨询</span> </button>
																											<button class="btn btn-primary details_btn" v-if="$check_action('/recruitment_information/details','set')" @click="change_praise()" ><span>点赞</span></button>
																<button class="btn btn-primary details_btn" v-if="$check_action('/recruitment_information/details','set')" @click="change_collect()" ><span>收藏</span></button>
											</div>
						<!-- 富文本 -->
				...
				if (this.state_collect) {
					...
					this.state_collect = true;
																		query.title = this.obj.enterprise_name
																								query.img = this.obj.office_environment
