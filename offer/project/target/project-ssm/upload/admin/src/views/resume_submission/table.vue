<template>
	...
	<el-row class="rows row2">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/resume_submission/table','set') || $check_action('/resume_submission/view','set') || $check_action('/resume_submission/view','get') || $check_action('/通知/table','add') || $check_action('/通知/view','add')" >
				...
				<template slot-scope="scope">
					...
					v-if="user_group == '管理员' || $check_action('/resume_submission/table','set') || $check_action('/resume_submission/view','set') || $check_action('/resume_submission/view','get')"
						...
						<!--跨表按钮-->
							<el-button class="e-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/interview_notification/view')" v-if="user_group == '管理员' || $check_action('/interview_notification/table','add') || $check_action('/interview_notification/view','add')">
						<span>通知</span>
					</el-button>
							</div>
				</template>
