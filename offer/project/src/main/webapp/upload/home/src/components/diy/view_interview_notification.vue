	...
	export default {
		...
		methods: {
			...
			get_obj_after(json, func){
																																																					...
																																																					if(json.result.obj["interview_time"]=="0000-00-00 00:00:00"){
				  json.result.obj["interview_time"] = null;
				}
				if(parseInt(json.result.obj["interview_time"]) > 9999){
					json.result.obj["interview_time"] = this.$toTime(parseInt(json.result.obj["interview_time"]),"yyyy-MM-dd hh:mm:ss")
				}
