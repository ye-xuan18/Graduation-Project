...
const routes = [
	...
	//博主信息列表路由
	{
		path: '/blogger_information/list',
		name: '/blogger_information_list',
		component: () => import('../views/blogger_information/list.vue')
	},
	//博主信息详情路由
	{
		path: '/blogger_information/details',
		name: '/blogger_information_details',
		component: () => import('../views/blogger_information/details.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "个人博客系统-home";
	document.title = title;
	document.logo = "个人博客系统"
})
