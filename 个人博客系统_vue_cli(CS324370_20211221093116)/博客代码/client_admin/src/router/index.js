...
const routes = [
	...
	// 博主信息路由
	{
		path: '/blogger_information/table',
		name: 'blogger_information_table',
		component: () => import('../views/blogger_information/table.vue')
	},
	{
		path: '/blogger_information/view',
		name: 'blogger_information_view',
		component: () => import('../views/blogger_information/view.vue')
	},
	// 用户注册路由
	{
