		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','date_of_birth') || $check_field('add','date_of_birth') || $check_field('set','date_of_birth')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="出生日期" prop="date_of_birth">
					<el-date-picker :disabled="disabledObj['date_of_birth_isDisabled']" v-if="user_group === '管理员' || (form_sub['user_registration_id'] && $check_field('set','date_of_birth')) || (!form_sub['user_registration_id'] && $check_field('add','date_of_birth'))" id="date_of_birth"
