<template>
	<view>
		...
		<view class="hot-wrapper" v-if="tabCurrentIndex==0">
			<uni-list>
			    <uni-list-item @click="navDetail(item)" v-for="(item,index) in hotQas" :title="item.title" :show-extra-icon="true" :extra-icon="{size: '22',type: 'help'}"></uni-list-item>
			</uni-list>
		</view>
		<view class="all-wrapper" v-if="tabCurrentIndex==1">
			...
			<view class="qa-wrapper">
				<uni-list>
				    <uni-list-item @click="navDetail(item)" v-for="(item,index) in qas" :title="item.title" :show-extra-icon="true" :extra-icon="{size: '22',type: 'help'}"></uni-list-item>
				</uni-list>
			</view>
		</view>
		<!-- #ifdef MP-WEIXIN -->
