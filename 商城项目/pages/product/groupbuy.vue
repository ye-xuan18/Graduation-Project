<template>
	<view class="container">
		...
		<view class="introduce-section" v-if="!product.skuEnabled">
			<text class="title"><u-tag :text="groupbuy.minUserCount+'人团'" mode="dark" type="error" />{{product.productName}}</text>
			...
			<u-cell-item :arrow="false" :use-label-slot="false" v-for="(item,index) in groupBuyList" v-if="index<2">
				...
				<view slot="title" style="margin-left: 20px;">
					<view style="font-size: 13px;">
						{{item.nickName}}, 还差<text class="num">{{item.remainingCount}}人</text>成团
					</view>
					<view class="">
