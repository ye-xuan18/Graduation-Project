<template>
	<view class="content">
		...
		<view class="aftersale-image">
			<text>凭证</text>
			<custom-image-upload :enableDel="false" :enableAdd="false" :enableDrag="false" v-model="imageUrlList" fileKeyName="files" :header="header" :formData="formData" :server-url="uploadUrl"></custom-image-upload>
		</view>
