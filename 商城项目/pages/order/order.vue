<template>
	<view class="content">
				...
				<scroll-view class="list-scroll-content" scroll-y @scrolltolower="loadMore">
					...
					<view v-for="(item,index) in orderList" :key="index" class="order-item">
						<view class="i-top b-b">
							...
							<uni-icons v-if="item.orderStatus==='4'" class="del-btn" type="trash" size="20" @click="deleteOrder(item)"></uni-icons>
						</view>
		...
		<login-banner :redirectUrl="redirectUrl"></login-banner>
	</view>
</template>
...
<script>
	...
	export default {
		...
		data() {
			return {
				redirectUrl: escape('/pages/order/order?state=0'),
				orderList: [],
				pageNo: 1,
				pageSize: 10,
				tabCurrentIndex: 0,
