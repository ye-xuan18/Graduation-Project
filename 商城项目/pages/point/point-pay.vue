	...
	<view class="app">
		...
		<view class="pay-type-list">
			<view class="type-item b-b" @click="changePayType(1)">
				<uni-icons custom-prefix="iconfont" type="icon-pay-wechat" color="#3BCA72" size="35"></uni-icons>
				<view class="con">
			...
			<view class="type-item b-b" @click="changePayType(2)">
				<uni-icons custom-prefix="iconfont" type="icon-pay-alipay" color="#5A9EF7" size="35"></uni-icons>
				<view class="con">
			...
			<view class="type-item" @click="changePayType(3)">
				<uni-icons custom-prefix="iconfont" type="icon-pay-balance" color="#FE9C01" size="35"></uni-icons>
				<view class="con">
