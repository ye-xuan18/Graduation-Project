export const apiBaseUrl = 'https://b2c.ccmao.net/b2c/rest/'
...
const methodsToken = [
	...
	'consumer/getUserCouponTotal',
	'consumer/getBestCoupon',
	'consumer/inquiryVoucher',
	'consumer/calculateDiscountAmount',
	...
	'consumer/searchStatement',
	'consumer/searchUserPerformance',
	'consumer/searchUserWithdraw',
	'consumer/applyWithdraw',
	'consumer/inquiryUserWithdraw',
	'consumer/searchUserCharge',
	'consumer/inquiryUserCharge',
	'consumer/applyCharge',
	'consumer/charge/initWechatPay',
	'consumer/charge/initWechatPayH5',
	'consumer/charge/initWechatPayApp',
	'consumer/charge/initAlipay',
	'consumer/charge/initAlipayApp',
	...
	'consumer/balancePay',
	'consumer/addUserUpgrade',
	'consumer/searchUserUpgrade',
	'consumer/inquiryUserUpgrade',
	'consumer/upgrade/initWechatPay',
	'consumer/upgrade/initWechatPayH5',
	'consumer/upgrade/initWechatPayApp',
	'consumer/upgrade/initAlipay',
	'consumer/upgrade/initAlipayApp',
	'consumer/upgrade/balancePay',
...
// 获取微信电话号码
export const wechatPhoneNumber = (data, callback, hideLoading) => post('consumer/getWechatPhoneNumber', data, callback, hideLoading);
...
// 团购商品详情
export const groupBuyDetail = (data, callback, hideLoading) => post('public/groupBuyDetail', data, callback, hideLoading);
...
// 获取积分商品分类
export const pointProductCate = (data, callback, hideLoading) => post('public/getPointProductCate', data, callback, hideLoading);
...
// 计算使用会员折扣的优惠金额
export const calculateDiscountAmount = (data, callback, hideLoading) => post('consumer/calculateDiscountAmount', data, callback, hideLoading);
...
//查询会员等级
export const inquiryUserLevel = (data, callback, hideLoading) => post('public/getUserLevel', data, callback, hideLoading);

//购买会员
export const addUserUpgrade = (data, callback, hideLoading) => post('consumer/addUserUpgrade', data, callback, hideLoading);

//分页查询购买会员记录
export const searchUserUpgrade = (data, callback, hideLoading) => post('consumer/searchUserUpgrade', data, callback, hideLoading);

//查询购买会员
export const inquiryUserUpgrade = (data, callback, hideLoading) => post('consumer/inquiryUserUpgrade', data, callback, hideLoading);

//会员购买小程序微信支付接口
export const upgradeWechatPay = (data, callback, hideLoading) => post('consumer/upgrade/initWechatPay', data, callback, hideLoading);

//会员购买公众号微信支付接口
export const upgradeWechatPayH5 = (data, callback, hideLoading) => post('consumer/upgrade/initWechatPayH5', data, callback, hideLoading);

//会员购买APP微信支付接口
export const upgradeWechatPayApp = (data, callback, hideLoading) => post('consumer/upgrade/initWechatPayApp', data, callback, hideLoading);

//会员购买支付宝H5端接口
export const upgradeAlipay = (data, callback, hideLoading) => post('consumer/upgrade/initAlipay', data, callback, hideLoading);

//会员购买支付宝APP端接口
export const upgradeAlipayApp = (data, callback, hideLoading) => post('consumer/upgrade/initAlipayApp', data, callback, hideLoading);

//会员购买余额支付接口
export const upgradeBalancePay = (data, callback, hideLoading) => post('consumer/upgrade/balancePay', data, callback, hideLoading);

//会员充值小程序微信支付接口
export const chargeWechatPay = (data, callback, hideLoading) => post('consumer/charge/initWechatPay', data, callback, hideLoading);

//会员充值公众号微信支付接口
export const chargeWechatPayH5 = (data, callback, hideLoading) => post('consumer/charge/initWechatPayH5', data, callback, hideLoading);

//会员充值APP微信支付接口
export const chargeWechatPayApp = (data, callback, hideLoading) => post('consumer/charge/initWechatPayApp', data, callback, hideLoading);

//会员充值支付宝H5端接口
export const chargeAlipay = (data, callback, hideLoading) => post('consumer/charge/initAlipay', data, callback, hideLoading);

//会员充值支付宝APP端接口
export const chargeAlipayApp = (data, callback, hideLoading) => post('consumer/charge/initAlipayApp', data, callback, hideLoading);
...
// 用户已领取的优惠券数量
export const userCouponNum = (data, callback, hideLoading) => post('consumer/getUserCouponTotal', data, callback, hideLoading);

// 根据选择的商品获取扣减最多的优惠券
export const bestCoupon = (data, callback, hideLoading) => post('consumer/getBestCoupon', data, callback, hideLoading);
...
// 获取用户余额明细
export const getStatementList = (data, callback, hideLoading) => post('consumer/searchStatement', data, callback, hideLoading);
...
// 用户充值
export const applyCharge = (data, callback, hideLoading) => post('consumer/applyCharge', data, callback, hideLoading);

// 用户充值列表
export const chargeList = (data, callback, hideLoading) => post('consumer/searchUserCharge', data, callback, hideLoading);

// 查询充值详情
export const chargeDetail = (data, callback, hideLoading) => post('consumer/inquiryUserCharge', data, callback, hideLoading);
...
//查询新人福利
export const inquiryProfitWelfare = (data, callback, hideLoading) => post('public/inquiryProfitWelfare', data, callback, hideLoading);
...
//获取充值设置
export const chargeSetting = (data, callback, hideLoading) => post('public/getChargeSetting', data, callback, hideLoading);